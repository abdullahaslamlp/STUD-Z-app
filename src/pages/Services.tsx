...
const features = [
  ...
  },
  {
    icon: Clock,
    title: "Cram Mode ⏰",
    desc: "Finals tomorrow? Cram Mode condenses your entire semester's notes into bite-sized summaries prioritized by exam relevance. We've all been there.",
    glow: "purple" as const,
  },
  {
    icon: Zap,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-slide-up">
          <h1 className="text-4xl sm:text-5xl font-display font-bold mb-4">
            Our <span className="text-gradient-neon">Features</span> ⚡
          </h1>
          <p className="text-muted-foreground max-w-xl mx-auto text-lg">
            Every tool you need to dominate your studies — all in one place.
          </p>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {features.map((f, i) => (
            <GlassCard key={f.title} glow={f.glow} className="space-y-4" style={{ animationDelay: `${i * 100}ms` }}>
